...
interface PlantOptionsProps {
  ...
  onStartDrag: (plant: Plant) => void;
  onClose: () => void;
}

export function PlantOptions({ plant, onMoveToGreenhouse, onStartDrag, onClose }: PlantOptionsProps) {
  ...
  return (
    <Modal visible={!!plant} transparent animationType="fade" onRequestClose={onClose}>
      ...
      <View style={styles.sheet}>
        ...
        <TouchableOpacity
          style={styles.option}
          onPress={() => { onStartDrag(plant); onClose(); }}
          accessibilityRole="button"
        >
          <Text style={styles.optionText}>↔️  Move to another plot</Text>
        </TouchableOpacity>
